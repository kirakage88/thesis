...
- [ ] 🔴 **Rewrite the thesis title** — `1.1 JOHN PACALDO`  
- [ ] 🔴 **Rewrite the research gap** — `1.1 JOHN PACALDO`  
...
- [ ] 🔴 **🤖 Train convolutional autoencoder**  
      ...
      - Save best model (lowest val\_loss) as `cnn_vibration_autoencoder.pth`.  
...
- [ ] 🔴 **🤖 Complete preprocessing pipeline**  
      ...
      - Output: X\_all, metadata (unit\_id, timestamp, kit\_id, location) saved to `02_Data/processed/`.
